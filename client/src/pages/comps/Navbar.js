            ...
            <nav className="p-4 m-4 md:pl-20 mr-0">
                <div className="container mx-auto flex justify-between items-center">
                    ...
                    <a className="inline-flex items-center text-black-800 font-bold gap-2.5 text-xl md:text-2xl" href="/">
                        <span className="">Ai Background Generator</span>
                    </a>
                    <nav className="hidden lg:flex gap-12">
                        ...
                        {!username ? (
                            <a className="hover:text-indigo-500 active:text-indigo-700 text-lg font-semibold transition duration-100 lg:text-base lg:font-normal" href="/about">About</a>
                        ) : null}
                        {role == 'admin' ? (
